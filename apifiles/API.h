...
/* u64 será el tipo de dato primitivo utilizado. */
...
/* 	Declaración del tipo de dato que representa el network y su flujo asociado. */
struct NetworkYFlujo;
typedef struct NetworkYFlujo DovahkiinSt;
typedef struct NetworkYFlujo* DovahkiinP;
